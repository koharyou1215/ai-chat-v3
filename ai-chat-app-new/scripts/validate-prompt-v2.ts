...
const testCharacter: Character = {
  ...
  data: {
    ...
    first_mes: 'こんにちは！今日はいい天気ですね。',
    mes_example: '<START>\nUser: 元気？\nAI: はい、元気です！あなたは？\n<END>',
    creator_notes: 'テスト用キャラクター',
    system_prompt: 'あなたは親切なアシスタントです。',
    post_history_instructions: '常に丁寧に応答してください。',
    tags: ['テスト', 'サンプル'],
    creator: 'test-creator',
    character_version: '1.0.0',
    alternate_greetings: ['やあ！', 'こんにちは〜'],
    extensions: {},
...
const testPersona: Persona = {
  ...
  role: 'ユーザー',
  avatar_url: '/test/user-avatar.png',
