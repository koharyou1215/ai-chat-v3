        ...
        >
          ...
          <div className="grid grid-cols-2 gap-4 text-xs">
            <div className="flex items-center justify-between">
              ...
              <span className="text-white/80">
                {Object.values(sessionLayers).reduce((total: number, layer: unknown) => {
                  const messages = (layer as Record<string, unknown>)?.messages;
            ...
            <div className="flex items-center justify-between">
              ...
              <span className="text-white/80">
{Object.values(sessionLayers).filter((layer: unknown) => {
  const messages = (layer as Record<string, unknown>)?.messages;
