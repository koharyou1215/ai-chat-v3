...
export class InspirationService {
  ...
  private buildReplySuggestionPrompt(
    ...
    return `あなたは${speaker}として、${target}への返信を3つの異なるアプローチで生成してください。
...
- 会話の文脈と話題の流れ
- ${speaker}の発言意図と感情状態
- これまでの${speaker}のトーンとスタイル
- ${target}との関係性

### 生成する3つのアプローチ
各提案は80-150文字で、${speaker}の性格を反映させ、自然な会話として成立するように。

1. 【共感・受容型】
相手の気持ちに寄り添い、理解を示す温かい返信

2. 【質問・探求型】
話題を深掘りし、相手の思考を引き出す知的な返信

3. 【話題展開型】
新しい視点や関連する話題を提供する創造的な返信
